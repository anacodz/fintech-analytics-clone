...
## Project Structure
- `generate_data.py`: Python script to generate 1,000 synthetic users and realistic transactional events and load them into a SQLite database (`fi_money_clone.db`).
- `queries.sql`: Contains the core business SQL queries:
